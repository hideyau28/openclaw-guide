...
<Callout variant="tip">
**保護你嘅密碼：** AMOS Stealer 專門偷 Keychain 入面嘅密碼。用密碼管理工具可以減低被盜風險——[NordPass](https://go.nordpass.io/aff_c?offer_id=488&aff_id=143439&url_id=9356) 支援跨平台同步，仲有 data breach 監測功能。
</Callout>
